...
```{r}
grid <- read_csv("/Users/megansears/Documents/Repos/fourmile/38HRU_model/HRU_gridall.csv") %>%
  mutate(date = mdy(time),
         site = 'grid')

statn <- read_csv('/Users/megansears/Documents/Repos/fourmile/38HRU_model/HRU_statnall.csv') %>%
  mutate(date = mdy(time),
         site = 'statn')
...
tmin <- ggplot() +
  ...
  scale_fill_viridis_c(option = "mako", name = "Tmin difference (°C)") +
  theme_bw(base_size=13.5) +
  theme(
    legend.position = "bottom",
    panel.grid.major = element_blank(),
...
tmax <- ggplot() +
  ...
  scale_fill_viridis_c(option = "inferno", name = "Tmax difference (°C)") +
  theme_bw(base_size=13.5) +
  theme(
    legend.position = "bottom",
    panel.grid.major = element_blank(),
