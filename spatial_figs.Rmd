...
```{r}
grid <- read_csv("/Users/megansears/Documents/Repos/fourmile/38HRU_model/output/4milecreek38HRUs-gridall_#1/out/Catchment.csv",
                 skip=3) %>%
   slice(3:n()) %>%
...
statn <- read_csv('/Users/megansears/Documents/Repos/fourmile/38HRU_model/output/4milecreek38HRUs-statnall_#1/out/Catchment.csv',
                 skip=3) %>%
   slice(3:n()) %>%
  dplyr::select(-starts_with('@'),
                -1) %>%
