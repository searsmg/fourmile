...
ggsave(filename = "./figures/diff_update2_wtitle&gauge.png",
       plot = final_plot,
       dpi = 800,
       bg = 'white',
       width = 12,
...
ggsave("/Users/megansears/Documents/Repos/fourmile/figures/flow_obs_plot2_eachyrlabel.png", dpi = 600, width = 12, height = 4, units = "in")
...
p_box <- catchment_mo_sum2 %>% 
  ...
  #        fill = guide_legend(title = NULL)) +
    ...
    fill = guide_legend(
      title = NULL,
      override.aes = list(shape = NA, linetype = 0)  # remove boxplot look
    )) +
    theme(
    panel.grid = element_blank(),
    panel.background = element_rect(fill = "white"),
...
ggsave("/Users/megansears/Documents/Repos/fourmile/figures/precip_box.png", plot = p_cols, width = 8, height = 6, dpi = 300)
...
ggsave("/Users/megansears/Documents/Repos/fourmile/figures/quad_20250329_timEdits.png", plot = quad, dpi = 600)
...
ggsave("/Users/megansears/Documents/Repos/fourmile/figures/quad_plus_timEdits.png", plot = quad_plus, dpi = 600,
       width = 14,
       height = 12,
       bg='white')
