...
quad_plus <- ggarrange(flow_plot,quad,
                       nrow=2)
quad_plus

ggsave("./figures/quad_plus.png", plot = quad_plus, dpi = 600)
...
p_cols <- ggplot(catchment_mo2, aes(x = month_name, y = avg_p,
                                    color = site, fill = site)) +
  geom_col(position = 'dodge') +
...
t_moplot <- ggplot(catchment_mo2, aes(x = month_name, y = tmean_mean, 
                                      color = site, group = site)) +
  geom_ribbon(aes(ymin = tmean_mean - tmean_sd, ymax = tmean_mean + tmean_sd, fill = site), alpha = 0.4) +
  geom_line() +
  geom_point() +
  scale_color_manual(values = c("blue", "orange"),
                     labels = c("Gridded", "Observed")) +  # Set line color to blue and orange and rename
...
sol_moplot <- ggplot(catchment_mo2, aes(x = month_name, y = solrad_mean, 
                                         color = site, group = site)) +
  geom_ribbon(aes(ymin = solrad_mean - solrad_sd, ymax = solrad_mean + solrad_sd, fill = site), alpha = 0.4) +
  geom_line() +
  geom_point() +
  scale_color_manual(values = c("blue", "orange"),
                     labels = c("Gridded", "Observed")) +  # Set line color to blue and orange and rename
...
rh_moplot <- ggplot(catchment_mo2, aes(x = month_name, y = rh_mean, 
                                        color = site, group = site)) +
  geom_ribbon(aes(ymin = rh_mean - rh_sd, ymax = rh_mean + rh_sd, fill = site), alpha = 0.4) +
  geom_line() +
  geom_point() +
  scale_color_manual(values = c("blue", "orange"),
                     labels = c("Gridded", "Observed")) +  # Set line color to blue and orange and rename
...
ggsave("/Users/megansears/Documents/Repos/fourmile/figures/quad.png", plot = quad, dpi = 600)
...
ggsave("./figures/quad_plus2.png", plot = quad_plus, dpi = 600)
