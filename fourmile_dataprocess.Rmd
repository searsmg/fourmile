...
setwd('/Users/megansears/Documents/Repos/fourmile/data')
...
load('/Users/megansears/Documents/Repos/fourmile/data/GIS/spatial.Rdata') ## need to update with new locations + fire boundary ***
...
#look at 2011-2013
hydro_datelimit <- ggplot(daily_q_ds3, aes(x=date, y=q_m3s, color=site)) + geom_point() + 
  theme_bw() + 
