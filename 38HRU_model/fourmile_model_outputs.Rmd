...
#name all the csv
names(dataframes) <- substr(filenames, 1, 9)
...
grid_2011 <- read_cals(grid2011., name = 'grid_2011')
grid_2012 <- read_cals(grid2012., name = 'grid_2012')
grid_2013 <- read_cals(grid2013., name = 'grid_2013')
grid_2014 <- read_cals(grid2014., name = 'grid_2014')
grid_2015 <- read_cals(grid2015., name = 'grid_2015')
grid_2016 <- read_cals(grid2016., name = 'grid_2016')
grid_2017 <- read_cals(grid2017., name = 'grid_2017')
grid_2018 <- read_cals(grid2018., name = 'grid_2018')
grid_2019 <- read_cals(grid2019., name = 'grid_2019')
grid_2020 <- read_cals(grid2020., name = 'grid_2020')
grid_all <- read_cals(gridall.c, name = 'grid_all')
...
statn_2011 <- read_cals(statn2011, name = 'statn_2011')
statn_2012 <- read_cals(statn2012, name = 'statn_2012')
statn_2013 <- read_cals(statn2013, name = 'statn_2013')
statn_2014 <- read_cals(statn2014, name = 'statn_2014')
statn_2015 <- read_cals(statn2015, name = 'statn_2015')
statn_2016 <- read_cals(statn2016, name = 'statn_2016')
statn_2017 <- read_cals(statn2017, name = 'statn_2017')
statn_2018 <- read_cals(statn2018, name = 'statn_2018')
statn_2019 <- read_cals(statn2019, name = 'statn_2019')
statn_2020 <- read_cals(statn2020, name = 'statn_2020')
statn_all <- read_cals(statnall., name = 'statn_all')
