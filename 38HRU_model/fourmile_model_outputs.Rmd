...
write_csv(params_weighted, './params_weighted.csv')
...
gw_gridall <- read_csv(here('catchment_output/gridall_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'grid_all')

gw_statnall <- read_csv(here('catchment_output/statnall_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'statn_all')

gw_grid2011 <- read_csv(here('catchment_output/grid2011_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'grid_2011')

gw_grid2012 <- read_csv(here('catchment_output/grid2012_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'grid_2012')

gw_grid2013 <- read_csv(here('catchment_output/grid2013_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'grid_2013')

gw_grid2014 <- read_csv(here('catchment_output/grid2014_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'grid_2014')

gw_grid2015 <- read_csv(here('catchment_output/grid2015_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'grid_2015')

gw_grid2016 <- read_csv(here('catchment_output/grid2016_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'grid_2016')

gw_grid2017 <- read_csv(here('catchment_output/grid2017_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'grid_2017')

gw_grid2018 <- read_csv(here('catchment_output/grid2018_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'grid_2018')

gw_grid2019 <- read_csv(here('catchment_output/grid2019_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'grid_2019')

gw_grid2020 <- read_csv(here('catchment_output/grid2020_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'grid_2020')

gw_statn2011 <- read_csv(here('catchment_output/statn2011_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'statn_2011')

gw_statn2012 <- read_csv(here('catchment_output/statn2012_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'statn_2012')

gw_statn2013 <- read_csv(here('catchment_output/statn2013_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'statn_2013')

gw_statn2014 <- read_csv(here('catchment_output/statn2014_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'statn_2014')

gw_statn2015 <- read_csv(here('catchment_output/statn2015_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'statn_2015')

gw_statn2016 <- read_csv(here('catchment_output/statn2016_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'statn_2016')

gw_statn2017 <- read_csv(here('catchment_output/statn2017_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'statn_2017')

gw_statn2018 <- read_csv(here('catchment_output/statn2018_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'statn_2018')

gw_statn2019 <- read_csv(here('catchment_output/statn2019_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'statn_2019')

gw_statn2020 <- read_csv(here('catchment_output/statn2020_outlet.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
...
#grid first
setwd("/Users/megansears/Documents/Repos/fourmile/38HRU_model/HRU_output/grid_all")
...
#statn next
setwd("/Users/megansears/Documents/Repos/fourmile/38HRU_model/HRU_output/statn_all")
