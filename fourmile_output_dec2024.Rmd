...
perf <- read_csv('/Users/megansears/Documents/Repos/fourmile/38HRU_dec2024_updates/all_kge.csv') %>%
  dplyr::select(year, model_run, value, metric)

perf <- perf %>%
  pivot_wider(names_from=metric,
               values_from=value)

nse_kge <- ggplot(perf, aes(x=kge, y=nse)) + 
  geom_point(size=1) +
