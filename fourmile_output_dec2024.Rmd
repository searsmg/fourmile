...
flow_plot_updated <- flow_plot_updated %>%
  mutate(kge_revise_bins = cut(kge,
                               ...
                               include.lowest = TRUE,
                               labels = c("< 0.0", "0.2-0.4", "0.4-0.6", "0.6-0.8", "> 0.8")))
...
# max_abs <- max(abs(flow_plot_updated$pbias), na.rm = TRUE)
# 
# both_pbias_plot <- flow_plot_updated %>%
#   ggplot(aes(x = year_excluded, 
#              y = year, 
...
ggsave('/Users/megansears/Documents/Repos/fourmile/figures/pbias_heatmap_both_basic_0center.png',
       dpi=600,
       width = 10,
       height = 6)
...
ggsave('/Users/megansears/Documents/Repos/fourmile/figures/water_partition_combine.png',
       dpi=600,
       width=12,
       height=12)
