...
ggplot(flow_plot_updated, aes(x = model_run, y = year, fill = pbias)) +
  geom_tile(color = "white") +
   scale_fill_gradient2(low = "blue", mid = "white", high = "red", midpoint = 0, name = "Ppias") +
...
gw_gridall <- read_csv(here('38HRU_sept2013_updates/catchment_output/grid_all.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'grid_all')

gw_statnall <- read_csv(here('38HRU_sept2013_updates/catchment_output/statn_all.csv')) %>%
  dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
  mutate(source = 'statn_all')

# gw_grid2011 <- read_csv(here('38HRU_sept2013_updates/catchment_output/grid_2011.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'grid_2011')
# 
# gw_grid2012 <- read_csv(here('38HRU_sept2013_updates/catchment_output/grid_2012.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'grid_2012')
# 
# gw_grid2013 <- read_csv(here('38HRU_sept2013_updates/catchment_output/grid_2013.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'grid_2013')
# 
# gw_grid2014 <- read_csv(here('38HRU_sept2013_updates/catchment_output/grid_2014.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'grid_2014')
# 
# gw_grid2015 <- read_csv(here('38HRU_sept2013_updates/catchment_output/grid_2015.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'grid_2015')
# 
# gw_grid2016 <- read_csv(here('38HRU_sept2013_updates/catchment_output/grid_2016.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'grid_2016')
# 
# gw_grid2017 <- read_csv(here('38HRU_sept2013_updates/catchment_output/grid_2017.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'grid_2017')
# 
# gw_grid2018 <- read_csv(here('38HRU_sept2013_updates/catchment_output/grid_2018.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'grid_2018')
# 
# gw_grid2019 <- read_csv(here('38HRU_sept2013_updates/catchment_output/grid_2019.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'grid_2019')
# 
# gw_grid2020 <- read_csv(here('38HRU_sept2013_updates/catchment_output/grid_2020.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'grid_2020')
# 
# gw_statn2011 <- read_csv(here('38HRU_sept2013_updates/catchment_output/statn_2011.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'statn_2011')
# 
# gw_statn2012 <- read_csv(here('38HRU_sept2013_updates/catchment_output/statn_2012.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'statn_2012')
# 
# gw_statn2013 <- read_csv(here('38HRU_sept2013_updates/catchment_output/statn_2013.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'statn_2013')
# 
# gw_statn2014 <- read_csv(here('38HRU_sept2013_updates/catchment_output/statn_2014.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'statn_2014')
# 
# gw_statn2015 <- read_csv(here('38HRU_sept2013_updates/catchment_output/statn_2015.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'statn_2015')
# 
# gw_statn2016 <- read_csv(here('38HRU_sept2013_updates/catchment_output/statn_2016.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'statn_2016')
# 
# gw_statn2017 <- read_csv(here('38HRU_sept2013_updates/catchment_output/statn_2017.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'statn_2017')
# 
# gw_statn2018 <- read_csv(here('38HRU_sept2013_updates/catchment_output/statn_2018.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'statn_2018')
# 
# gw_statn2019 <- read_csv(here('38HRU_sept2013_updates/catchment_output/statn_2019.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
#   mutate(source = 'statn_2019')
# 
# gw_statn2020 <- read_csv(here('38HRU_sept2013_updates/catchment_output/statn_2020.csv')) %>%
#   dplyr::select(time, catchmentRD1_w, catchmentRD2_w, catchmentRG1_w, catchmentRG2_w) %>%
...
flow_season %>%
  ...
  #geom_point(aes(color = source)) +
  facet_wrap(~season) +
  ggtitle('RD/RG annual sums') +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  theme(text = element_text(size = 20)) +
  labs(y = 'Total flow (m3)')
...
hrus <- st_read('/Users/megansears/Documents/Repos/fourmile/38HRU_model/hrus_final.shp')

mapview(hrus)

locations <- read_csv('/Users/megansears/Documents/Repos/fourmile/38HRU_model/fourmile_sensors.csv')
