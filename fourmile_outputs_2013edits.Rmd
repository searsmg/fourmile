...
rd1_grid_plot <- ggplot(rd1_grid, aes(x=time, y=rd1_summed, color=elevation_group)) + 
  geom_line() +
  scale_color_viridis_c() +  # Use a continuous viridis color palette
  theme_bw()

ggplotly(rd1_grid_plot)

rd1_statn_plot <- ggplot(rd1_statn, aes(x=time, y=rd1_summed, color=elevation_group)) + 
  geom_line() +
  scale_color_viridis_c() +
  theme_bw()

ggplotly(rd1_statn_plot)
...
rd2_grid_plot <- ggplot(rd2_grid, aes(x=time, y=rd2_summed, color=elevation_group)) + 
  geom_line() +
  scale_color_viridis_c() +  # Use a continuous viridis color palette
  theme_bw()

ggplotly(rd2_grid_plot)

rd2_statn_plot <- ggplot(rd2_statn, aes(x=time, y=rd2_summed, color=elevation)) + 
  geom_line() +
  scale_color_viridis_c(option = 'mako') +
  theme_bw()

ggplotly(rd2_statn_plot)
