...
```{r rd and rg, fig.height=20, fig.width=22, echo = F}
...
ggplot(gw, aes(x=date, color = source)) +
  geom_line(aes(y=genRD1)) +
  facet_wrap(~year, scales = 'free') +
  scale_x_date(labels = date_format("%b")) +
  ggtitle('genRD1')

ggplot(gw, aes(x=date, color = source)) +
  geom_line(aes(y=genRD2)) +
  facet_wrap(~year, scales = 'free') +
  scale_x_date(labels = date_format("%b")) +
  ggtitle('genRD2')
  
ggplot(gw, aes(x=date, color = source)) +
  geom_line(aes(y=genRG1)) +
  facet_wrap(~year, scales = 'free') +
  scale_x_date(labels = date_format("%b")) +
  ggtitle('genRG1')

ggplot(gw, aes(x=date, color = source)) +
  geom_line(aes(y=genRG2)) +
  facet_wrap(~year, scales = 'free') +
  scale_x_date(labels = date_format("%b")) +
  ggtitle('genRG2')
...
ggplot(gw, aes(x=date, color = source)) +
  geom_line(aes(y=RD1cumsum)) +
  facet_wrap(~year, scales = 'free') +
  scale_x_date(labels = date_format("%b")) +
  ggtitle('Cumulative genRD1')

ggplot(gw, aes(x=date, color = source)) +
  geom_line(aes(y=RD2cumsum)) +
  facet_wrap(~year, scales = 'free') +
  scale_x_date(labels = date_format("%b")) +
  ggtitle('Cumulative genRD2')
  
ggplot(gw, aes(x=date, color = source)) +
  geom_line(aes(y=RG1cumsum)) +
  facet_wrap(~year, scales = 'free') +
  scale_x_date(labels = date_format("%b")) +
  ggtitle('Cumulative genRG1')

ggplot(gw, aes(x=date, color = source)) +
  geom_line(aes(y=RG2cumsum)) +
  facet_wrap(~year, scales = 'free') +
  scale_x_date(labels = date_format("%b")) +
...
```{r niwot, fig.height=20, fig.width=22, echo = F}
library(snotelr)
...
```{r hru7 temp, fig.height=20, fig.width=22, echo = F}
