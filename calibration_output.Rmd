...
marpeakq <- ggplot(early_peakq, aes(x = doy_bouldcr)) +
  geom_point(aes(y = doy_all_ensemble, shape = "all_ensemble"), size=2.5) +
  geom_point(aes(y = doy_grid_all, shape = 'grid_all'), size=2.5) +
  geom_point(aes(y = doy_grid_ensemble, shape = 'grid_ensemble'), size=2.5) +
  geom_point(aes(y = doy_statn_all, shape = 'statn_all'), size=2.5) +
  geom_point(aes(y = doy_statn_ensemble, shape = 'statn_ensemble'), size=2.5) +
  geom_abline(intercept = 0, slope = 1, size=1, color='red') +
  labs(x = "Boulder Creek DOY for March Peak Q", y = 'DOY for March Peak Q') +
  theme_bw() +
