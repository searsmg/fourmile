...
setwd("C:/Users/sears/Documents/Repos/fourmile/catchments")
...
-Look at SWE dataframe as a group
...
#look at swe -- ****** ask about this
niwot_swe <- niwot %>%
  dplyr::select(date, swe_mm_snotel, swe_mm_hrugrid, swe_mm_hrustatn) %>%
  mutate(swe_mm_snotel2 = swe_mm_snotel - lag(swe_mm_snotel))
...
# niwot_swe <- niwot_swe %>% 
#   pivot_longer(!date, names_to = 'source', values_to = 'swe_mm')
