...
flow_year <- flow %>%
  mutate(WY = addWaterYear()) %>%
  group_by(WY) %>%
  summarize(kge_grid2011 = KGE(grid_2011, obs),
            kge_grid2012 = KGE(grid_2012, obs),
            kge_grid2013 = KGE(grid_2013, obs),
            kge_grid2014 = KGE(grid_2014, obs),
            kge_grid2015 = KGE(grid_2015, obs),
            kge_grid2016 = KGE(grid_2016, obs),
            kge_grid2017 = KGE(grid_2017, obs),
            kge_grid2018 = KGE(grid_2018, obs),
            kge_grid2019 = KGE(grid_2019, obs),
            kge_grid2020 = KGE(grid_2020, obs),
            kge_gridall = KGE(grid_all, obs),
            kge_statn2011 = KGE(statn_2011, obs),
            kge_statn2012 = KGE(statn_2012, obs),
            kge_statn2013 = KGE(statn_2013, obs),
            kge_statn2014 = KGE(statn_2014, obs),
            kge_statn2015 = KGE(statn_2015, obs),
            kge_statn2016 = KGE(statn_2016, obs),
            kge_statn2017 = KGE(statn_2017, obs),
            kge_statn2018 = KGE(statn_2018, obs),
            kge_statn2019 = KGE(statn_2019, obs),
            kge_statn2020 = KGE(statn_2020, obs),
            kge_statnall = KGE(statn_all, obs)) %>%
    mutate_if(is.numeric,
            round,
            digits = 2)
