...
tmax_grid <- read_csv('C:/Users/sears/Documents/Repos/fourmile/HRU_output/reg_tmaxAll_prism.csv') %>% 
...
tmax_statn <- read_csv('C:/Users/sears/Documents/Repos/fourmile/HRU_output/reg_tmaxAll.csv') %>% 
  pivot_longer(cols = `3`:`19`,
               names_to = 'value', 
...
tmax_grid_mo <- read_csv('C:/Users/sears/Documents/Repos/fourmile/HRU_output/reg_tmaxAll_prism.csv') %>% 
  pivot_longer(cols = `3`:`19`,
               names_to = 'value', 
               values_to = 'tmax_grid') %>%
  mutate(time = dmy(time),
...
tmax_statn_mo <- read_csv('C:/Users/sears/Documents/Repos/fourmile/HRU_output/reg_tmaxAll.csv') %>% 
  pivot_longer(cols = `3`:`19`,
               names_to = 'value', 
               values_to = 'tmax_statn') %>%
  mutate(time = dmy(time),
...
tmin_grid <- read_csv('C:/Users/sears/Documents/Repos/fourmile/HRU_output/reg_tminAll_prism.csv') %>% 
  pivot_longer(cols = `3`:`19`,
               names_to = 'value', 
               values_to = 'tmin_grid') %>%
  mutate(time = dmy(time)) %>%
...
tmin_statn <- read_csv('C:/Users/sears/Documents/Repos/fourmile/HRU_output/reg_tminAll.csv') %>% 
  pivot_longer(cols = `3`:`19`,
               names_to = 'value', 
...
```{r tmin month, echo = F}
tmin_grid_mo <- read_csv('C:/Users/sears/Documents/Repos/fourmile/HRU_output/reg_tminAll_prism.csv') %>% 
  pivot_longer(cols = `3`:`19`,
               names_to = 'value', 
               values_to = 'tmin_grid') %>%
  mutate(time = dmy(time),
...
tmin_statn_mo <- read_csv('C:/Users/sears/Documents/Repos/fourmile/HRU_output/reg_tminAll.csv') %>% 
  pivot_longer(cols = `3`:`19`,
               names_to = 'value', 
               values_to = 'tmin_statn') %>%
  mutate(time = dmy(time),
...
## Average soil sat difference comparison
