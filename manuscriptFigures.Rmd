...
otherParamsWeighted <- read_csv('./38HRU_dec2024_updates/updated_wranges/params_weighted_dec2024_ranges.csv') %>%
  filter(!param %in% c('lagSurfaceRunoff',
                       'a_rain',
                       'a_snow')) %>%
  rename(value = area_weighted_average,
...
otherParams <- read_csv('./38HRU_dec2024_updates/updated_wranges/params_unburn_ranges.csv') %>%
  filter(!param %in% c('soilOutLPS',
                       'snow_trs',
                       'lagInterflow',
                       'baseTemp',
